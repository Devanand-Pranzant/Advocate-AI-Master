        ...
        {options && options.length > 0 ? (
          options.map((option, idx) => (
            <button
              ...
              style={{
                color: option.variant === 'danger' ? "#DC2626" : (option.variant === 'success' ? "#059669" : getTextColor())
              }}
            ...
            >
              {option.icon ? (
                ...
                option.label.toLowerCase().includes('delete') ? <Trash2 className="w-4 h-4 mr-3" /> :
                  option.label.toLowerCase().includes('view') || option.label.toLowerCase().includes('detail') ? <Eye className="w-4 h-4 mr-3" /> :
                    option.label.toLowerCase().includes('edit') ? <Edit className="w-4 h-4 mr-3" /> :
