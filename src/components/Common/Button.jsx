...
const Button = ({
  ...
  const variants = {
    ...
    primary: {
      bg: theme?.headerBg || '#3b82f6', // ✅ USE THEME COLOR
      text: '#ffffff',
      border: theme?.headerBg || '#3b82f6',
      hover: '#2563eb',
      focus: '#93c5fd'
    },
    success: {
