...
const Table = ({
  ...
  if (loading) {
    return (
      <div
        className={`rounded-xl border overflow-x-auto ${className}`}
        style={{
      ...
      <style>
        {`
          ...
          .custom-scrollbar::-webkit-scrollbar-track {
            background: ${theme.mode === "Dark" ? "#2d3748" : "#f1f5f9"} !important;
          }

          .custom-scrollbar::-webkit-scrollbar-thumb {
            background-color: ${theme.mode === "Dark" ? "#4a5568" : "#cbd5e0"} !important;
            border-radius: 6px;
          }
        `}
      </style>
