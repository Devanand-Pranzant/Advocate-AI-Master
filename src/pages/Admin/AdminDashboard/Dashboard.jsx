...
const STATIC_DATA = {
  ...
  todaysHearings: [
    ...
    },
    {
      id: 6,
      caseType: 'Family Law',
      Case_Title: 'Williams Custody Battle',
      hearingDate: moment().format('YYYY-MM-DD'),
    ...
    },
    {
      id: 8,
      caseType: 'Civil Law',
      Case_Title: 'Property Dispute: Jones vs. City',
      hearingDate: moment().format('YYYY-MM-DD'),
      hearingTime: '9:30 AM'
    }
  ],
  ...
  todaysAppointments: [
    ...
    },
    {
      ...
      appointment_datetime: moment().format('YYYY-MM-DD') + ' 09:15:00',
      client_contact: '+1 (555) 456-7890'
    },
    {
      client_name: 'Jennifer Lopez',
      appointment_datetime: moment().format('YYYY-MM-DD') + ' 11:45:00',
      client_contact: '+1 (555) 234-5678'
    },
    {
      client_name: 'Robert Chen',
      appointment_datetime: moment().format('YYYY-MM-DD') + ' 16:00:00',
      client_contact: '+1 (555) 876-5432'
    }
  ]
};
...
const Dashboard = () => {
  ...
  const [hearings, setHearings] = useState(STATIC_DATA.todaysHearings);
  ...
  const handleDateClick = (date) => {
    ...
    setHearings(filteredHearings.length > 0 ? filteredHearings : []);
    setHearingsPage(1);
    ...
    setAppointments(filteredAppointments.length > 0 ? filteredAppointments : []);
  ...
  const handleRefresh = () => {
    setLoading(true);
    setTimeout(() => {
      setHearings(STATIC_DATA.todaysHearings);
      setAppointments(STATIC_DATA.todaysAppointments);
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
              ...
              >
                <div className="grid grid-cols-2 gap-2 h-full">
                  ...
                  >
                    <h6 className="text-[10px] mb-0.5" style={{ color: themeUtils.getTextColor(false) }}>Total Clients</h6>
                    <h3 className="text-lg font-bold" style={{ color: "#aa9166" }}>{STATIC_DATA.totalClients}</h3>
                  </div>
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-1.5 h-[calc(100%-32px)]">
                  <a
                    href="/all-cases"
